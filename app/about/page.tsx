		...
		<>
			...
			<div className="about-hero__wrapper" id="about-for-anchor">
				...
				<div className="about-hero">
					...
					<div className="about-hero__text">Это один из крупнейший в Украине магазин для поиска и выбора комплектующих для ноутбуков всех популярных брендов. С помощью нашего сайта вы можете без особых профессиональных навыков выбрать себе необходимые комплектующие по модели вашего ноутбука</div>
				</div>
				...
				<div className="about">
					<div className="about__block">
						...
						<div className="about__texts">
							<div className="about__text">Которые любят и ценят свою работу.  Мы энергичны, молоды и всегда развиваемся. Наши специалисты готовы решить Ваши проблемы, связанные с подбором комплектующих, профессионально и быстро! </div>
							<div className="about__text">Работа, направленная на то, чтобы заработать и сохранить доверие наших клиентов, - это главный двигатель подхода нашей компании с первого дня.</div>
						</div>
					</div>
					<div className="about__block">
						...
						<div className="about__texts">
							<div className="about__text">Обеспечить посетителям максимально удобный сайт для выбора и приобретения запчастей для ноутбука, а так же создать максимально широкий ассортимент для выбора комплектующих.</div>
							<div className="about__text">Мы стараемся создать высокий сервис и максимально облегчить покупку комплектующих для ноутбука предоставив лучший выбор и необходимую информацию о товарах.</div>
						</div>
					</div>
				</div>
			</div>
