...
const FeaturesCard: React.FC<FeaturesCardProps> = ({ name, price, discount, photo_url, product, isBought, isFav }) => {
	...
	return (
		<div className="features-card">
			<div className="features-card__image-wrapper">{photo_url ? <Image fill={true} src={photo_url} alt="photo_url" className="features-card__image" sizes="(max-width: 600px) 147px, 230px"></Image> : <Image fill={true} src={noImageIcon} alt="photo_url" className="features-card__image"></Image>}</div>
