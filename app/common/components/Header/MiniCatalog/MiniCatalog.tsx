		...
		<div className="mini-catalog" onClick={closeDropdown}>
			...
			<div className={`mini-catalog__big-menu ${bigMenuActive ? "active" : ""}`}>
				{items.map((item, index) => (
					<HeaderMiniCatalogItem key={index} item={item} isOpen={activeIndex === index} bigMenuActive={bigMenuActive} toggleItem={() => toggleItem(index)} activeProperty={activeProperty} setActiveProperty={setActiveProperty} setBigMenuActive={setBigMenuActive} />
				))}
