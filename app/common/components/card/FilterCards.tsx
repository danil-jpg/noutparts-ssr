    ...
    const RenderProperFilter = (): React.ReactElement => {
        switch (type) {
            case 'matrices':
                return (
                    <>
                        {selector.map((el: IMatrixCard, index) => {
                            return (
            ...
            case 'batteries':
                return (
                    <>
                        {selector.map((el: IBatteryCard, index) => {
                            return (
                                <div key={index} className='card'>
                                    <div className='card__tag'>
                                        <ProductTag type={el.attributes.tag as 'discount' | 'new' | 'salesHit'}></ProductTag>
            ...
            case 'hdds':
                return (
                    <>
                        {selector.map((el: IHddCard, index) => {
                            return (
                                <div key={index} className='card'>
                                    <div className='card__tag'>
                                        <ProductTag type={el.attributes.tag as 'discount' | 'new' | 'salesHit'}></ProductTag>
            ...
            case 'keyboards':
                return (
                    <>
                        {selector.map((el: IKeyboard, index) => {
                            return (
                                <div key={index} className='card'>
                                    <div className='card__tag'>
                                        <ProductTag type={el.attributes.tag as 'discount' | 'new' | 'salesHit'}></ProductTag>
            ...
            case 'power-Supplies':
                return (
                    <>
                        {selector.map((el: IPowerSupply, index) => {
                            return (
                                <div key={index} className='card'>
                                    <div className='card__tag'>
                                        <ProductTag type={el.attributes.tag as 'discount' | 'new' | 'salesHit'}></ProductTag>
